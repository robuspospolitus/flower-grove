        ...
        <div className="posts-page">
            ...
            <div className="posts-wrapper">
                <div className="posts-carousel">
                    {
                        examplePostStructure.map((each) => (
                        <div className='blue' key={each.id}>
                            <h3 className="post-header">{each.title} </h3>
                            {each.description} 
                            <button onClick={()=>{setActive(each.id)}}>Show more!</button>
                        </div>
                        ))
                    }
                </div>
            ...
            {active!=0 && 
                <ModalWindow close={setActive} data={examplePostStructure[active-1]}/>
            }
        </div>
        <Footer/>
        </>
